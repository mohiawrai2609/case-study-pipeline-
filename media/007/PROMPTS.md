# Media prompts — No. 007: Elementary School Teachers, Except Special Education

RPI 3.5% · APS 29% capable · HRF 88% human-protected · 21 tasks · 13 vendors

## How to use this

1. Generate each item below in whatever tool you prefer.
2. Save it into `media/007/` using the **exact filename given**.
...
**Save as:** `media/007/empty_classroom_dawn.png`  ·  **16:9** (full-bleed)

*Caption in article:* The room before the children: manipulatives, laminated word walls and a lesson plan that generated itself overnight.
...
**Save as:** `media/007/read_aloud_circle.png`  ·  **3:2** (inline)

*Caption in article:* Reading aloud remains stubbornly, expensively human: pacing, vocal expression and the interruption you did not plan for.
...
**Save as:** `media/007/district_board_meeting.png`  ·  **3:2** (inline)

*Caption in article:* The real gate on classroom AI is not model capability. It is a room with a public comment period.
...
**Save as:** `media/007/kneeling_beside_desk.png`  ·  **3:2** (inline)

*Caption in article:* The task with the lowest automation potential in the anatomy: deciding, in three seconds, which kind of stuck this child is.
...
**Save as:** `media/007/adaptive_platform_review.png`  ·  **3:2** (inline)

*Caption in article:* The work the technology created: checking whether the platform has quietly put the right child on the wrong pathway.
